...
export OPENAI_API_KEY="sk-avne8SvhUWVhdqbCvmKik55tCmvecVdwaYActqgAE9T3BlbkFJmLIRoDpGENZsLyZtOnOxGD6e72nGjooOx2e8SEFgQA"
export QT_QPA_PLATFORMTHEME=qt6ct
fish_add_path path $HOME/.pub-cache/bin
fish_add_path path $HOME/Scripts/
fish_add_path path $HOME/.config/emacs/bin
fish_add_path path $HOME/Downloads/git/wezterm/target/release
